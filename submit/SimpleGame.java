...
public class SimpleGame {
	...
	public static void main(String[] args) {
		...
		// TODO: Your code goes here
		SimpleGame ourGame = new SimpleGame();
		...
		// TODO: Your code goes here
		System.out.print("Which game do you want to play?[1,2]: ");
		ourGame.userInput = sc.nextInt();
		if(ourGame.userInput == 1){
			System.out.print("Enter the number of seconds: ");
			ourGame.userInput = sc.nextInt();
			System.out.println(ourGame.convertTime(ourGame.userInput));
		} else if(ourGame.userInput == 2) {
			System.out.print("Enter your digit: ");
			ourGame.userInput = sc.nextInt();
			System.out.println(ourGame.digitsSum(ourGame.userInput));
		} else {
			System.out.println("You choosed invalid game");
		}
		sc.close();
	}	
}